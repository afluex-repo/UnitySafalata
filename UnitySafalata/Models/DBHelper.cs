...
namespace UnitySafalata.Models
{
    public class DBHelper
    {
        ...
        static DBHelper()
        {
            try
            { 
                connectionString = "Data Source=103.48.51.111,1232;Initial Catalog=UnitySafalataDB;User Id=UnitySafalataUser;Password=unity@123!@#;Integrated Security=false;";
            }
            catch (Exception)
            {
                throw;
